...
public class DiskManagerTest extends TestCase {
	...
	public void testReadWriteDisk(){
    	...
    	Person mother1 = new Person ("Mother1", "Ven�l�inen", true);
     	Person mother2 = new Person ("Mother2", "Suomalainen", true);
    	Person mother3 = new Person ("Mother3", "Ruotsalainen", true);
    	Person father1 = new Person ("Father1", "Ven�l�inen", false);
    	Person father2 = new Person ("Father2", "Suomalainen", false);
    	Person father3 = new Person ("Father3", "Ruotsalainen", false);
    	
    	
    	Person child11 = new Person ("Child Daughter1", "Ven�l�inen", true);
    	Person child12 = new Person ("Child Daughter2", "Ven�l�inen", true);
    	...
    	Person child24_only_husbands = new Person ("Child Son4", "Suomalainen is�", false);    	
